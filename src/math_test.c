...
START_TEST(pow_tests) {
  ...
  ck_assert_int_eq(pow(2, S21_INF), s21_pow(2, S21_INF));
  ck_assert_int_eq(pow(2, S21_mINF), s21_pow(2, S21_mINF));
  ck_assert_int_eq(pow(2, S21_NAN), s21_pow(2, S21_NAN));

  ck_assert_int_eq(pow(S21_INF, 2), s21_pow(S21_INF, 2));
  ck_assert_int_eq(pow(S21_mINF, 2), s21_pow(S21_mINF, 2));
}
END_TEST
...
START_TEST(ceil_tests) {
  ...
  ck_assert_float_eq(ceil(S21_mINF), s21_ceil(S21_mINF));
}
END_TEST
...
START_TEST(cos_tests) {
  ...
  ck_assert_int_eq(cos(S21_mINF), s21_cos(S21_mINF));
...
START_TEST(atan_tests) {
  ...
  ck_assert_int_eq(atan(S21_mINF), s21_atan(S21_mINF));
